...
async function main() {
  await mongoose.connect('mongodb+srv://komalm02022004:Snehal@cluster0.xvikhua.mongodb.net/Service?retryWrites=true&w=majority&appName=Cluster0');
}
app.get("/", (req, res) => {
  res.status(200).send("Welcome to thapa technical Mern Series Updated");
});

app.post("/api/auth/register",validate(signupSchema), async (req, res,next) => {
  try {
